...
function renderButtons() {
  ...
  let pepButton = document.querySelector('.btn-pepperoni');
  let mushroomButton = document.querySelector('.btn-mushrooms');
  let greenpepButton = document.querySelector('.btn-green-peppers');
...
function renderPrice() {
  ...
  let total = basePrice;
  let panelPrice = document.querySelector('aside ul');
  ...
  for (var key in ingredients){
    if(state[key]){
      ...
      newPriceItem.innerHTML += `${ingredients[key].price} ${ingredients[key].name}`;
